...
export function RecipesProvider({ children }) {
  ...
  function addNewRecipe() {
    const newRecipe = {
      ...
      origin: "Unknown",
      instructions: "Instr...",
      ingredientsNames: ["Ingr..."],
      ingredientsMeasures: ["200g"],
    };
  ...
  return (
    <RecipesContext.Provider value={{ recipes, addNewRecipe, deleteRecipe }}>
      {children}
...
const sampleRecipes = [
  {
    ...
    ingredientsNames: ["Onion", "Potatos"],
    ingredientsMeasures: ["1 sliced", "400g"],
  },
  {
    id: uuidv4(),
    ...
    ingredientsNames: ["penne rigate", "olive oil"],
    ingredientsMeasures: ["1 pound", "1/4 cup"],
  },
  {
    id: uuidv4(),
    name: "Lamb Biryani",
    ...
    ingredientsNames: ["Cashew nuts", "Cumin seeds"],
    ingredientsMeasures: ["12", "\u00bd tbsp"],
  },
];
